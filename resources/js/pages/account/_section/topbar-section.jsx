    ...
    return (
        <div className="sticky top-0 z-20 flex h-16 shrink-0 items-center gap-4 border-b border-gray-100 bg-white px-4 sm:px-6">
            ...
            <div className="ml-auto flex items-center gap-3">
                <Link
                    href="/hosting-plan"
                    className="hidden sm:inline-flex items-center rounded-md border border-slate-200 bg-white px-3.5 py-2 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 transition-colors"
                >
                    Upgrade plan
                </Link>
