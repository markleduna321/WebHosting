      ...
      <div className="max-w-6xl mx-auto">
        <div className="border-b border-slate-200 dark:border-slate-800 pb-8 mb-10">
          ...
          <p className="mt-4 text-base text-slate-600 dark:text-slate-300 max-w-3xl leading-relaxed">
            These Terms of Service ("Terms") govern your access to and use of CALEHO Host's
            web hosting, domain, and cloud services. By using our services, you agree to these Terms.
          </p>
        </div>
        ...
        <main className="bg-white dark:bg-slate-900/30 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800/80 space-y-10">
          <section>
            ...
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              By creating an account or using any CALEHO Host service, you confirm that you have
              read, understood, and agree to be bound by these Terms and our Privacy Policy.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">2. Account Responsibilities</h2>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">3. Acceptable Use</h2>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              You agree not to use our services for any unlawful purpose, to distribute malware,
              or to engage in activity that disrupts or abuses our infrastructure or other users.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">4. Billing &amp; Cancellation</h2>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              Subscriptions are billed according to the plan you select. You may cancel at any
          ...
          <section className="pt-6 border-t border-slate-200 dark:border-slate-800">
            ...
            <div className="bg-slate-100 dark:bg-slate-950 p-4 rounded-xl border border-slate-200 dark:border-slate-800 text-sm space-y-1">
              <p className="text-slate-900 dark:text-white font-medium">Caleho Cloud Support</p>
